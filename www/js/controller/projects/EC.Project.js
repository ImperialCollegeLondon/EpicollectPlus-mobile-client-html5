...
EC.Project = ( function() {"use strict";
        ...
        function _autoload(the_project_to_autoload) {
            ...
            //There is a project to autoload: warn user if the project is already loaded on the device
        ...
        function getList() {
            ...
            if (!EC.Utils.isChrome()) {
                switch(window.device.platform) {
                    ...
                    //ON android project name is in the url as a query string param ?project=my_project
                    ...
                    //ON iOS project name is part of the custom url scheme and it is already parsed and stored in localStorage
                    case EC.Const.IOS:
                        project_to_autoload = window.localStorage.ios_project_form_url;
                        break;
            ...
            $.when(EC.Select.getProjects()).then(function(the_projects) {
                ...
                if (project_to_autoload === "") {
                    ...
                    $.when(_autoload(project_to_autoload)).then(function() {
                        ...
                        //we get here when trying to autoload a project already on the device, just render stored projects
        ...
        function renderList(the_projects) {
            ...
            for ( i = 0, iLength = projects.length; i < iLength; i++) {
            ...
            //cache project names in localStorage, to be used when checking for project name uniqueness
            window.localStorage.project_names = JSON.stringify(project_names);
        ...
        var deleteProject = function() {
            ...
            //@bug: panel closes itself on changePage, .panel('close') will stop the panel from working
