...
EC.Update = ( function(module) {"use strict";
		...
		var _updateDataSyncedFlagTX = function(tx) {
			...
			for ( i = 0; i < iLength; i++) {
				...
				tx.executeSql(query, [1, branch_rows_to_sync[i]._id], _updateDataSyncedFlagSQLSuccess, EC.Update.txErrorCB);
		...
		module.setBranchEntryAsSynced = function(the_branch_rows_to_sync) {
			...
			EC.db.transaction(_updateDataSyncedFlagTX, EC.Update.txErrorCB, _updateDataSyncedFlagSuccessCB);
