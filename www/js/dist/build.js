...
EC.BranchInputs = ( function() {"use strict";
		...
		return {
			 ...
			 */
			getList : function(the_branch_form_name, the_project_id) {
			...
			setInputs : function(the_branch_inputs, the_has_jumps_flag) {
			...
			setCachedBranchEntryKeys : function(the_branch_form_name, the_primary_keys) {
			...
			getCachedBranchEntryKeys : function(the_branch_form_name) {
...
EC.Routing.branchInputsPageEvents = function() {"use strict";
